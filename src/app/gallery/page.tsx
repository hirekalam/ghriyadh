    ...
    <div className="flex flex-col w-full min-h-screen bg-warm-white">
      ...
      <section className="relative bg-primary-deep text-warm-white py-20 md:py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 w-full text-right space-y-4">
          ...
          <h1 className="text-3xl md:text-5xl font-black text-white">معرض أعمالنا وملهمات اللاندسكيب</h1>
      ...
      <section className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-6 md:px-12 space-y-12">
          ...
          {/* Filters Bar */}
          <div className="flex flex-wrap items-center justify-center gap-2 border-b border-charcoal/5 pb-8">
              ...
              <button
                ...
                className={`px-5 py-2.5 rounded-full text-xs font-bold transition-all duration-200 ${
                  activeFilter === category
                    ...
                    : 'bg-warm-white text-muted-grey border border-charcoal/5 hover:bg-charcoal/5'
                }`}
              >
                {category}
              </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredItems.map((item, idx) => (
              <div
                key={idx}
                className="group bg-warm-white border border-charcoal/5 rounded-3xl overflow-hidden shadow-card hover:shadow-card-hover transition-all duration-300 flex flex-col"
              >
                ...
                <div className="p-5 text-right space-y-1">
                  <span className="text-[10px] font-bold text-botanical tracking-wider block uppercase">
                    {item.category}
                  </span>
          ...
          {/* Honest Disclaimer */}
          <div className="p-6 bg-botanical/5 border border-botanical/15 rounded-2xl max-w-3xl mx-auto text-center text-xs text-muted-grey leading-relaxed">
      ...
      <section className="bg-primary-deep text-warm-white py-16 text-center">
        <div className="max-w-3xl mx-auto px-6 space-y-6">
          <h2 className="text-2xl md:text-3xl font-black text-white">هل أعجبك أحد التصاميم أو العناصر السابقة؟</h2>
